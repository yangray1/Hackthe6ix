...
public class backCar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn = (Button) findViewById(R.id.topPicture);
            ...
            post("https://api.imgur.com/3/image", new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    if (response.isSuccessful()) {
                        ...
                        Intent intent = new Intent(backCar.this , frontCar.class);
                        ...
                        intent.putExtra("Front",getPercentDamaged.percentTotalled);
                        intent.putExtra("backImage", pickedImage.toString());
                        dialog.dismiss();
